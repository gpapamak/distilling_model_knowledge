function backProp_logistic_inputs(obj)
% Backpropagates derivatives through nade, with logistic hidden layer. It
% only computes and stores the derivatives wrt the input. Assumes that
% forward propagation has already been performed.
%
...
% derivatives wrt a
dLda = dLdb .* repmat(obj.U, 1, 1, N) .* obj.h .* (1 - obj.h);

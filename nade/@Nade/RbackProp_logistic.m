function RbackProp_logistic(obj, vx)
% R{backprop} in nade, with logistic hidden layer. Assumes that both
% forward and backward propagation have already been performed.
% INPUT
...
% derivatives wrt a
RdLda = (obj.RdLdU .* (1-obj.h) - obj.dLdU .* Rh) .* repmat(obj.U, 1, 1, N);
